...
function calculateVariableEventPosition(
  ...
  // Night hours (0-7, 20-23): 0.3 each = 12 * 0.3 = 3.6
  // Day hours (8-19): 1.5 each = 12 * 1.5 = 18
  // Total: 21.6 units
...
export function WeekView({ currentDate, events }: WeekViewProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Week header with day names and dates - compact */}
      <div className="grid grid-cols-[40px_repeat(7,1fr)] border-b border-border bg-card">
